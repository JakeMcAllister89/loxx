      ...
      <header className="bg-[#fafafa] text-foreground border-b border-border/60">
        <div className="container flex items-center justify-between py-4">
          ...
          <nav className="flex items-center gap-2">
            <Link to="/guides/what-is-a-master-key-system" className="text-sm px-3 py-2 text-foreground/70 hover:text-foreground">Guide</Link>
      ...
      <div className="p-5 h-full flex flex-col gap-4 bg-slate-50/40">
        ...
        <div className="grid grid-cols-4 gap-2.5">
          {[
            ...
            { l: "Issued keys", v: "64", d: "+4" },
            { l: "Unresolved lost keys", v: "2", d: "-1" },
          ].map((s) => (
